...
from models import User, Game, Prompt, PromptType, Base
...
def migrate_prompts():
    ...
    try:
        ...
        base_path = Path("/ai_diplomacy") / "prompts"
        
        # Define prompt mappings: (prompt_type, file_paths)
        prompt_mappings = [
            # System prompts
            (PromptType.SYSTEM, [
                base_path / "system_prompt.txt",
                base_path / "standardized_system_prompts" / "austria_system_prompt.txt",
                base_path / "standardized_system_prompts" / "england_system_prompt.txt",
                base_path / "standardized_system_prompts" / "france_system_prompt.txt",
                base_path / "standardized_system_prompts" / "germany_system_prompt.txt",
                base_path / "standardized_system_prompts" / "italy_system_prompt.txt",
                base_path / "standardized_system_prompts" / "russia_system_prompt.txt",
                base_path / "standardized_system_prompts" / "turkey_system_prompt.txt",
            ]),
            
            # Order prompts
            (PromptType.ORDER, [
                base_path / "order_instructions_movement_phase.txt",
                base_path / "order_instructions_retreat_phase.txt",
                base_path / "order_instructions_adjustment_phase.txt",
            ]),
